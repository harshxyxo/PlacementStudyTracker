  ...
  return (
    ...
    <main className="relative z-10 w-full max-w-[440px] px-margin-mobile md:px-0 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="bg-surface-container rounded-2xl border border-outline-variant/50 p-gutter md:p-8 shadow-2xl shadow-black/50 backdrop-blur-sm flex flex-col gap-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,220,229,0.15)]">
        ...
        <div className="flex flex-col items-center text-center gap-stack-gap">
          ...
          <p className="font-body-md text-body-md text-on-surface-variant">
            Start tracking your placements and studies today.
          </p>
        </div>
        ...
        <button 
          ...
          disabled
          title="Coming soon"
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg bg-transparent border border-outline-variant text-on-surface hover:border-primary-fixed-dim/50 hover:bg-surface-variant/30 transition-all group font-body-md text-body-md opacity-50 cursor-not-allowed"
        >
        ...
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-stack-gap">
            ...
            <div className="flex flex-col gap-2">
              <label className="font-label-caps text-label-caps text-on-surface-variant uppercase ml-1" htmlFor="name">Full Name</label>
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline group-focus-within:text-primary-fixed-dim transition-colors text-[20px]">person</span>
                <input 
      ...
      <p className="mt-8 text-center font-body-md text-body-md text-on-surface-variant">
        ...
        <Link className="text-primary-fixed-dim font-medium hover:text-primary-fixed transition-colors underline-offset-4 hover:underline ml-1" to="/login">
          Log in
        </Link>
      </p>
    </main>
