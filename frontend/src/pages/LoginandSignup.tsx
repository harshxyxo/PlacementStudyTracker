...
<div className="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-primary-fixed-dim/20 blur-[120px] mix-blend-screen"></div>
<div className="absolute bottom-[-20%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-secondary-fixed-dim/20 blur-[100px] mix-blend-screen"></div>
</div>
...
<button className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg bg-transparent border border-outline-variant text-on-surface hover:border-primary-fixed-dim/50 hover:bg-surface-variant/30 transition-all group font-body-md text-body-md">
...
<input className="w-full bg-surface-container-lowest border border-outline-variant rounded-lg py-3 pl-10 pr-4 font-body-md text-body-md text-on-surface placeholder:text-outline focus:outline-none focus:border-primary-fixed-dim focus:ring-1 focus:ring-primary-fixed-dim/50 transition-all" id="email" placeholder="student@university.edu" required={true} type="email" />
</div>
</div>
...
<input className="w-full bg-surface-container-lowest border border-outline-variant rounded-lg py-3 pl-10 pr-10 font-body-md text-body-md text-on-surface placeholder:text-outline focus:outline-none focus:border-primary-fixed-dim focus:ring-1 focus:ring-primary-fixed-dim/50 transition-all" id="password" placeholder="••••••••" required={true} type="password" />
<button className="absolute right-3 top-1/2 -translate-y-1/2 text-outline hover:text-on-surface transition-colors focus:outline-none" type="button">
...
<p className="mt-8 text-center font-body-md text-body-md text-on-surface-variant">
            ...
            <Link className="text-primary-fixed-dim font-medium hover:text-primary-fixed transition-colors underline-offset-4 hover:underline" to="#">
                Create an account
            </Link>
</p>
</main>
